# Izveidot programmu, kura prasa lietot�jam ievad�t cilindra
#  r�diusu un t� augstumu, tiek apr��in�ts cilindra 
# laukums un tilpums. Rezult�ts tiek par�d�ts konsol�.
